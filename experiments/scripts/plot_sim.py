...
if __name__ == "__main__":
    ...
    rmse_x = sqrt(mean_squared_error(gnd_data["x"], est_data["x"]))
    rmse_y = sqrt(mean_squared_error(gnd_data["y"], est_data["y"]))
    rmse_z = sqrt(mean_squared_error(gnd_data["z"], est_data["z"]))
    print("rmse x: %.4f" % rmse_x)
    print("rmse y: %.4f" % rmse_y)
    print("rmse z: %.4f" % rmse_z)

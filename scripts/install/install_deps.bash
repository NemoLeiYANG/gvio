...
# sudo bash opencv3_install.bash
# sudo bash ros_install.bash
sudo bash suitesparse_install.bash
sudo bash ueye-sdk_install.bash
sudo bash yaml-cpp_install.bash
